...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Point of Sale on PHP.">
        <meta name="msapplication-tap-highlight" content="no">
        <link rel="icon" type="images/png" sizes="180x180" href="assets/images/job-icon.png">
    ...
    <body class="text-center bg-midnight-bloom">
        ...
        <div class="text-center w-100">
            <form class="form-signin mt-5" method="POST" id="quickForm">
                <img class="mb-4" src="assets/images/peso.png" alt="" width="100" height="100">
                <div class="card">
                    <div class="card-body">
                ...
                <p class="mt-5 mb-3 text-muted text-light">&copy; 2020</p>
            </form>
        </div>
